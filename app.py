...
def main():
    ...
    /* ── Plotly chart background (ensure no dark bleed) ── */
    ...
    with st.sidebar:
        ...
        <div style='padding:0.5rem 0 1.5rem 0'>
            <div style='font-size:1.5rem;font-weight:800;color:#1e293b;font-family:DM Sans,sans-serif'>⚡ Plant Demand</div>
            <div style='font-size:0.8rem;color:#64748b;font-family:DM Sans,sans-serif'>50Hertz · WLL / WCL Automation</div>
        </div>
        """, unsafe_allow_html=True)
